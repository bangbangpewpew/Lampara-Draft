...
const Calendar = (props) => {
  return (
    <div className="calendar-container">
      <Helmet>
        <title>Calendar - Lampara</title>
        <meta property="og:title" content="Calendar - Lampara" />
      </Helmet>
      <div className="calendar-container1">
        <div className="calendar-container2">
          <h1 className="calendar-text">Admin</h1>
          ...
          <svg viewBox="0 0 1024 1024" className="calendar-icon02">
          ...
          <svg viewBox="0 0 1024 1024" className="calendar-icon09">
            <path d="M512 598q108 0 225 47t117 123v86h-684v-86q0-76 117-123t225-47zM512 512q-70 0-120-50t-50-120 50-121 120-51 120 51 50 121-50 120-120 50z"></path>
          </svg>
          <svg viewBox="0 0 1024 1024" className="calendar-icon11">
          ...
          <svg viewBox="0 0 1024 1024" className="calendar-icon13">
          ...
          <svg viewBox="0 0 1024 1024" className="calendar-icon15">
          ...
          <Link to="/dashboard" className="calendar-navlink">
            <img
              alt="image"
          ...
          <Link to="/dashboard" className="calendar-navlink1">
            <h1 className="calendar-text1">LAMPARA</h1>
          </Link>
          <Link to="/dashboard" className="calendar-navlink2 button">
            Scheduler
          </Link>
          <Link to="/dashboard" className="calendar-navlink3 button">
            Dashboard
          </Link>
          <button type="button" className="calendar-button button">
            Notification
          </button>
          <button type="button" className="calendar-button1 button">
            Reports
          </button>
          <button type="button" className="calendar-button2 button">
            Users
          </button>
          <Link to="/view-schedule" className="calendar-navlink4 button">
            Schedule
          </Link>
          <button type="button" className="calendar-button3 button">
            Account
          </button>
          <button type="button" className="calendar-button4 button">
            Settings
          </button>
        </div>
      </div>
